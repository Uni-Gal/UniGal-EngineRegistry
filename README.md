...
| - | - | - | - | - | - | - | - | - | - | - |
|  | Ayaka | rust desktop | ayaka script | 活跃 | 语法简单适合标准方研究支持 |  |  |  | MIT | https://github.com/Uni-Gal/Ayaka |
|  | Fungus | Unity | C# | 不活跃 | 暂无计划 |  |  |  | MIT | https://github.com/snozbot/fungus |
...
|  | Librian | Python | liber | **已停止维护** | （正在说服开发者） | √（开发中） | √（开发中） | √（开发中） | MPL-2.0 | http://librian.net/ |
...
|  | VoidNovel | SDL | C++ | **活跃** | （较为困难） |  |  |  | MIT | https://github.com/VoidmatrixHeathcliff/VoidNovelEngine |
...
|  | Kirino-Engine | Unity | C# | 已停止维护 | 暂无计划 |  |  |  |  | https://github.com/IJEMIN/Unity-Kirino-Engine |
|  | Krkr | Krkr | TJS | 已停止维护 |  |  |  | √（开发中） |  |  |
|  | Monogatari | json | json | **活跃** |  |  |  | √（开发中） |  | https://monogatari.io |
|  | Nova | Unity | Lua/C# (.txt) | **活跃** | （正在说服开发者） | √（开发中） | √（开发中） | √（开发中） |  | https://github.com/Lunatic-Works/Nova |
...
|  | [Naninovel]() | Unity | JS (.nani) | **活跃** | 做梦 | 做梦 | 做梦 | √（开发中） |  | https://naninovel.com/ |
|  | [VNVE](https://github.com/vnve/vnve) | js |  |  |  |  |  |  |  | https://vnve.github.io/vnve/ |
|  | iFAction | 橙光 | 可视化 | 不乐观 | 暂无计划 |  |  |  |  |  |
